...
public class Main_ResultEntity {

	public static void main(String[] args) throws JsonProcessingException {

		ResultEntity re = test01();
		...
		// 直接输出JSON
		System.out.println(ResultEntity.create().success().code(200).message("操作成功").asJSON());
		System.out.println(ResultEntity.create().failure().code(400).message("操作失败，客户端异常").asJSON());
	}
	
	public static ResultEntity test01() {
